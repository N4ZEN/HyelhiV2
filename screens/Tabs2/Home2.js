                    ...
                    {recent && 
                        <TouchableOpacity 
                            ...
                            style={{borderTopColor: COLORS.lightGray2, height: 50, flexDirection: 'row', 
                                justifyContent: 'space-between', alignItems: 'center', borderBottomColor: COLORS.lightGray, 
                                borderTopWidth: 2, borderBottomWidth: 1.5,backgroundColor: 'transparent',
                                marginTop:10, paddingHorizontal:10,}}
                        >
                            <Text style={{marginLeft: 10, fontSize: 16, fontFamily: 'PoppinsMedium', color: COLORS.darkGray, padding:10}}>My Recent Activity</Text>
                            <View style={{padding: 5,}}>
                                <MaterialIcons name='chevron-right' size={35} color={COLORS.darkGray}/>
                            </View>
                        </TouchableOpacity>
                    }
                </View>
